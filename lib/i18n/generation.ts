export const generationZhCN = {
  ...
  generation: {
    ...
    // Gamma AI classroom
    gammaCreate: '创建 Gamma 演示文稿',
    gammaCreateDesc: '正在向 Gamma AI 提交你的课程主题...',
    gammaWait: '等待 Gamma 生成',
    gammaWaitDesc: 'Gamma 正在设计并渲染幻灯片，请稍候...',
    gammaSlides: '转换幻灯片',
    gammaSlidesDesc: '正在将 Gamma 导出转换为课堂页面...',
    gammaScripts: '生成讲解脚本',
    gammaScriptsDesc: '正在为每张幻灯片编写导师讲解...',
    gammaQuizzes: '生成测验',
    gammaQuizzesDesc: '正在添加知识点检测题...',
    gammaTts: '生成语音',
    gammaTtsDesc: '正在为导师讲解合成语音...',
    gammaSave: '保存课堂',
    gammaSaveDesc: '正在保存你的 Gamma 课堂...',
  },
} as const;
...
export const generationEnUS = {
  ...
  generation: {
    ...
    // Gamma AI classroom
    gammaCreate: 'Creating Gamma presentation',
    gammaCreateDesc: 'Sending your lesson topic to Gamma AI...',
    gammaWait: 'Waiting for Gamma',
    gammaWaitDesc: 'Gamma is designing and rendering your slides...',
    gammaSlides: 'Converting slides',
    gammaSlidesDesc: 'Turning the Gamma export into classroom pages...',
    gammaScripts: 'Writing narration',
    gammaScriptsDesc: 'Generating tutor scripts for each slide...',
    gammaQuizzes: 'Building quizzes',
    gammaQuizzesDesc: 'Adding knowledge-check questions...',
    gammaTts: 'Generating voice',
    gammaTtsDesc: 'Synthesizing tutor speech audio...',
    gammaSave: 'Saving classroom',
    gammaSaveDesc: 'Saving your Gamma classroom...',
  },
} as const;
