export const stageZhCN = {
  ...
  whiteboard: {
    ...
    boardShortOpen: '画板',
    boardShortClose: '收起',
    boardTooltipOpen: '点这里打开画画的白板。',
    boardTooltipClose: '点这里把白板收起来。',
    clear: '清空白板',
    minimize: '最小化白板',
    ready: '白板已就绪',
  ...
  roundtable: {
    ...
    zoneTalkTitle: '我来说',
    zoneTalkHint: '点一点或打字',
    zoneFriendsTitle: '小伙伴',
    zoneFriendsHint: '一起学',
    inputPlaceholder: '想说的话写在这里…',
    listening: '正在听…',
    processing: '请稍等…',
    ...
    autoPlay: '自动播放',
    autoPlayOff: '关闭自动播放',
    autoPlayButtonTitle: '自动读',
    autoPlayButtonOn: '开',
    autoPlayButtonOff: '关',
    autoPlayTooltipOn: '打开后：老师读完这一页会自动继续下一页。',
    autoPlayTooltipOff: '关闭后：每一页要自己点「播放」才会读。',
    playLesson: '播放这一页',
    pauseLesson: '暂停',
    playLessonShort: '播放',
    pauseLessonShort: '暂停',
    speed: '倍速',
    speedButtonTitle: '多快',
    speedButtonSubtitle: '点一下换',
    speedTooltip: '点一下可以换「慢一点、正常、快一点」。',
    soundButtonLabel: '声音',
    soundMuteAria: '静音',
    soundUnmuteAria: '打开声音',
    soundTooltip: '点喇叭可静音；鼠标移上去会出现音量条。',
    voiceInput: '语音输入',
...
export const stageEnUS = {
  ...
  whiteboard: {
    ...
    boardShortOpen: 'Board',
    boardShortClose: 'Hide',
    boardTooltipOpen: 'Tap here to open the drawing board.',
    boardTooltipClose: 'Tap here to put the board away.',
  ...
  roundtable: {
    teacher: 'Teacher',
    you: 'You',
    zoneTeacherTitle: 'Teacher',
    zoneTeacherHint: 'Main voice',
    zoneTalkTitle: 'You talk',
    zoneTalkHint: 'Tap to speak or type',
    zoneFriendsTitle: 'Friends',
    zoneFriendsHint: 'Class helpers',
    inputPlaceholder: 'Say something here…',
    listening: 'Listening…',
    ...
    qaEnded: 'Q&A ended',
    thinking: 'Thinking…',
    yourTurn: 'Your turn — tap!',
    stopDiscussion: 'Stop Discussion',
    autoPlay: 'Auto-play',
    autoPlayOff: 'Stop auto-play',
    autoPlayButtonTitle: 'Auto read',
    autoPlayButtonOn: 'On',
    autoPlayButtonOff: 'Off',
    autoPlayTooltipOn: 'When this is on, the teacher voice keeps going to the next slide by itself.',
    autoPlayTooltipOff: 'When this is off, you tap play on each slide to hear it.',
    playLesson: 'Play this page',
    pauseLesson: 'Pause',
    playLessonShort: 'Play',
    pauseLessonShort: 'Pause',
    speed: 'Speed',
    speedButtonTitle: 'How fast',
    speedButtonSubtitle: 'Tap to change',
    speedTooltip: 'Tap to pick slower, normal, or faster reading.',
    soundButtonLabel: 'Sound',
    soundMuteAria: 'Mute',
    soundUnmuteAria: 'Unmute',
    soundTooltip: 'Tap the speaker to mute. Move the mouse on it to open the volume slider.',
