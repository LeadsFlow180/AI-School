...
export function ResizeHandler({
  ...
  return (
    <div
      className={`resize-handler absolute z-[130] w-[12px] h-[12px] left-0 top-0 rounded-[2px] border-2 border-white bg-sky-500 shadow-[0_0_0_1px_rgba(14,116,144,0.9)] ${cursorClass} ${className || ''}`}
      style={style}
